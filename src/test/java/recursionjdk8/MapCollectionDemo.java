...
public class MapCollectionDemo {
    ...
    private static Stream<String> SteamABCD;
    ...
    public static void main(String[] args) {
        ...
        //关于使用 reduce
        // 字符串连接，concat = "ABCD"    这里使采用reduce的方式没有中间连接
        List<String> stringListABCD = Stream.of("A", "B", "C", "D").collect(Collectors.toList());
        String concat = stringListABCD.stream().reduce("", String::concat);
        System.out.println("concat:" + concat);

        //使用中间连接的方式
        String joinString = stringListABCD.stream().collect(Collectors.joining("---"));
